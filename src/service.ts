...
export const billService = {
  ...
  getBills: Object.assign((data: { date: string }) => baseService.get(`/bill?date=${data.date}`), { method: "GET" }),
  getBillById: Object.assign((data: { id: string }) => baseService.get(`/bill/${data.id}`), { method: "GET" }),
};
